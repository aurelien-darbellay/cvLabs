...
export default function HomePage() {
    ...
    return (
        <div className="font-sans p-6">
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">Education ({education.length})</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">Experience ({experience.length})</h2>
                <ul className="list-disc pl-5">
                    {experience.map((ex) => (
                        <li key={ex.id}>
                            {ex.company} —{" "}
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">Languages ({languages.length})</h2>
                <ul className="list-disc pl-5">
                    {languages.map((l) => (
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">Soft Skills ({softSkills.length})</h2>
                <ul className="list-disc pl-5">
                    {softSkills.map((s) => (
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">Tech Skills ({techSkills.length})</h2>
                <ul className="list-disc pl-5">
                    {techSkills.map((t) => (
